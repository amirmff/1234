...
VOLUNTARYCHECK=0
I=1
BOT=sezar  # You can put here other bots. Also you can change it to run more than one bot in the same server.
...
while getopts ":tsTSih" opt; do
  case $opt in
	...
	echo -e "\e[1m"
	echo -e ""
	echo "steady.sh bash script v1.2 iicc 2016 sezar" >&2
	echo ""
	exit 1
      ;;
	h)
